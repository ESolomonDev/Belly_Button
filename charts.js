  ...
  d3.json("samples.json").then((data) => {
    ...
    var barLayout = {
      ...
      annotations: [{
        ...
        y: -0.25,
        yanchor: 'center',
        text: 'The bar chart displays the top 10 bacterial species (OTUs)<br>with the number of samples foun in the belly button',
        showarrow: false
      }]
    };
    // 10. Use Plotly to plot the data with the layout. 
    Plotly.newPlot('bar', barData, barLayout, { reponsive: true });
    ...
    var bubbleLayout = {
      ...
      showlegend: false,
      xaxis: { title: "PTU id", automargin: true },
    ...
    // console.log(Object.values(washFreqz)[6]);
